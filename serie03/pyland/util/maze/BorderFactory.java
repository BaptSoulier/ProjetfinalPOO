...
final class BorderFactory {
    ...
    private static final String HDOOR = "...";
    private static final String WALL = "|";
    private static final String CROSSING = "~~~";
    private static final String VDOOR = ":";
    ...
    static IDescriptor createHDoor(MazeRoom n, MazeRoom s) {
        return new AbstractDescriptor(new MazeRoom[] { n, s }) {
            protected String fullVision() {
                return isWay(VERTICAL) ? EMPTY3 : HDOOR;
            }
            protected String noVision() {
                return EMPTY3;
            }
    ...
    static IDescriptor createVDoor(MazeRoom e, MazeRoom w) {
        return new AbstractDescriptor(new MazeRoom[] { e, w }) {
            protected String fullVision() {
                return isWay(HORIZONTAL) ? EMPTY1 : VDOOR;
            }
            protected String noVision() {
                return EMPTY1;
            }
