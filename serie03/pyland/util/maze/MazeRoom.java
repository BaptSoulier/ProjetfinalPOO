...
final class MazeRoom {
    ...
    static MazeRoom createKeyRoom(Maze m, int i, int j) {
        MazeRoom r = new MazeRoom(new KeyRoom());
        r.setDescriptor(DescriptorFactory.createKey(r, m, i, j));
        return r;
    }
    ...
    static MazeRoom createDungeon(Maze m, int i, int j) {
        MazeRoom r = new MazeRoom(new Dungeon());
        r.setDescriptor(DescriptorFactory.createDungeon(r, m, i, j));
        return r;
    }
